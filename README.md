...
The UCR Planning, Design, and Construction (PD&C) department is responsible for forecasting and updating project timelines for clients across campus. A client support financial analyst meets with and works alongside project managers to maintain a static Excel sheet with Gantt charts and basic project information for a monthly capital project schedule for stakeholders. 

Additionally, historical data is recorded solely in previous documents, making analysis time-consuming and unstandardized. Siloed data and an outdated presentation led to an unprepared presentation, with more questions asked than answered.
